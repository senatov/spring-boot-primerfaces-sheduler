...
public class ScheduleView implements Serializable {
  ...
  @Serial private static final long serialVersionUID = -2637195560425203881L;

  private final ScheduleModel eventModel = new DefaultScheduleModel();
  @Autowired ScheduleRecordMapper mapper;
  ...
  private Duration getDuration(Object event, String opName) throws Exception {
    ...
    String msg =
        format(
            "%s event deltas: Day: %s, Hour: %s, Minutes: %s",
            opName, duratio.toDays(), duratio.toHours() % 24L, duratio.toMinutes() % (24L * 60L));
