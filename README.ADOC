...
tags: [Spring Boot 2.3.1, JSF 2.3.5 (v. 2.4 not compartible to Primefaces!), Primerfaces 8.0, Spring WebMVC, JDK14]
...
2) Components: Spring Boot 2.3.1, JSF 2.3.5 (v. 2.4 not compartible to Primefaces!), Primerfaces 8.0, JSE14 3) URLs:
