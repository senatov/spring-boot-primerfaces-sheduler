``_The Project builds under Oracle JDK 14.0.1 General-Availability Release_ ``

`Database is now under Docker https://hub.docker.com/repository/docker/senatov/postgres[repo]`
